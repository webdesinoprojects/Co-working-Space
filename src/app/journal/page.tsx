        ...
        <div className="bg-white/90 backdrop-blur-md rounded-full p-[5px] flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-6 pl-1">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link href="/journal" className="text-[14px] text-[#F26522] font-medium transition-colors">Journal</Link>
              <Link href="/connect" className="text-[14px] text-gray-900 hover:text-[#F26522] transition-colors">Connect</Link>
            </div>
          </div>
