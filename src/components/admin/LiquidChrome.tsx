...
export const LiquidChrome: React.FC<LiquidChromeProps> = ({
  baseColor = [0.9, 0.9, 0.9], // Defaulted to a lighter chrome to avoid being "too black"
  speed = 0.2,
  amplitude = 0.5,
  frequencyX = 3,
  frequencyY = 2,
  ...
  useEffect(() => {
    ...
    // Set clear color to transparent instead of white so it can blend better if needed
